...
import com.huetoyou.chatexchange.ui.misc.tutorial.ChatSlidingMenuTutorial;
import com.huetoyou.chatexchange.ui.misc.tutorial.HomeFragTutorial;
...
public class MainActivity extends SlidingActivity
{
    ...
    public static boolean touchesAllowed = true;
...
//        mActionBar.addView(newDrawer, 1);
        ...
        mChatroomSlidingMenu.setOnOpenedListener(new SlidingMenu.OnOpenedListener()
        {
            ...
            {
                ChatSlidingMenuTutorial hue = new ChatSlidingMenuTutorial();
                hue.show(MainActivity.this);
            }
        });
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        HomeFragTutorial hue = new HomeFragTutorial();
                        hue.show(MainActivity.this);
                    }
                });
            }
